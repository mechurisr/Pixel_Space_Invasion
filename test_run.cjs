...
let playerIds = [60];
let territories = Array.from({length: 60}, (_, i) => ({ id: i+1, name: 'T'+i, trait: 'TECH-CENTRIC', neighbors: [i+2], military: 20, oil: 30, tech: 30, isOccupied: false, mutationUnit: null, nukeStatus: null, hasMothership: false }));
territories[0].military = 60; // AI node
territories[0].neighbors = [2];
...
handleNextTurn();
console.log("AI territoryIds:", aiData[0].territoryIds);
console.log("Node 1 military:", territories[0].military);
console.log("Node 2 military:", territories[1].military);
